  ...
  return (
    ...
    >
      ...
      >
        <Badge
          variant="secondary"
          className="flex items-center relative px-4 py-4 text-base
          font-medium bg-white rounded-full group-hover:bg-gray-50
          transition-colors duration-200"
        >
          <Sparkles
            className="h-6 w-6 mr-1 text-rose-600 animate-pulse"
          />
      ...
      <div>
        <Button
          ...
          lg:text-xl rounded-full px-8 sm:px-10 lg:px-12 py-6
          sm:py-7 lg:py-8 lg:mt-16 bg-gradient-to-r from-slate-900
          to-rose-500 hover:from-rose-500 hover:to-slate-900
